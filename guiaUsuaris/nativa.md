...
Donem suport a la instal·lació i execució de l'aplicació nativa en els següents sistemes operatius:
 ...
 - *Windows* - Versions servidor [Server2003 R2 i superiors](https://en.wikipedia.org/wiki/List_of_Microsoft_Windows_versions#Server_versions) - _Windows server 2016 encara no està suportat >> estàra suportat de cara 18/04/2018 a la versió 1.0.0.7 de la nativa_
