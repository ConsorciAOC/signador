...
*	**hash_algorithm**: Algorisme de hash. Per defecte `SHA-256`. Altres possibles valors: `SHA-1`, `SHA-384` (només per versions de la Nativa iguals o superiors a la 2.1.1.0), i `SHA-512`. Camp no obligatori.
